...
/*
  ...
  PROJETO COM TEMA NATALINO - FATEC
...
// Declaração LEDs pisca-pisca
#define LED_VERM 13
#define LED_AMAR 12

// Definições de Musica
#define NOTE_B0  31
#define NOTE_C1  33
#define NOTE_CS1 35
#define NOTE_D1  37
...
void Musica() {
  ...
  for (int thisNote = 0; thisNote < notes * 2; thisNote = thisNote + 2) {
    ...
    // Alteração das cores do LED RGB
    analogWrite(LRGB_RED, controle_RED);
  	...
  	analogWrite(LRGB_BLUE, controle_GREEN);
    	...
    	// Reaproveitamento da var aux rgb para controle do pisca
    	if((auxiliar_RGB % 2) == 0){
